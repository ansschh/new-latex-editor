      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-white mb-2">Join LaTeX Scholar</h1>
            <p className="text-gray-400">Start your scientific writing journey with AI assistance</p>
          </div>
